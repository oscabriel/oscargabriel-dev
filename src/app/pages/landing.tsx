			...
			<div className="mx-auto max-w-3xl">
				...
				<div className="mb-8 space-y-4 text-base leading-relaxed">
					<div>
						...
						<a
							href="https://stumptowncoffee.com"
					...
					<div>
						...
						<span className="text-foreground underline decoration-muted-foreground transition-colors hover:decoration-foreground">
				...
				<div className="flex gap-6">
					...
					<a
						href="https://github.com/oscabriel"
						className="text-muted-foreground transition-colors hover:text-foreground"
					>
						<svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
							<title>GitHub</title>
